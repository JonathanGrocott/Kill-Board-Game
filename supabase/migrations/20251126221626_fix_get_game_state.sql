-- Force recreation of get_game_state function to fix GROUP BY error
-- This migration drops and recreates the function with proper subquery pattern
...
BEGIN
  SELECT json_build_object(
    ...
    'marbles', (
      -- Fixed: Use subquery to properly handle ORDER BY with json_agg
